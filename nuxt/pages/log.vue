...
<i18n locale="en" lang="json" src="@/locales/sfc/en/pages/log.json" />
<i18n locale="de" lang="json" src="@/locales/sfc/de/pages/log.json" />
<i18n locale="es" lang="json" src="@/locales/sfc/es/pages/log.json" />
<i18n locale="fr" lang="json" src="@/locales/sfc/fr/pages/log.json" />
<i18n locale="ko" lang="json" src="@/locales/sfc/ko/pages/log.json" />
<i18n locale="pt" lang="json" src="@/locales/sfc/pt/pages/log.json" />
<i18n locale="uk" lang="json" src="@/locales/sfc/uk/pages/log.json" />
