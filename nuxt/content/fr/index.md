...
<content-fifty-fifty
  ...
  :list="['Pas d\'horaires rigides', 'Pas de culpabilité si vous manquez un jour', 'Toute votre lecture compte']"
...
<content-fifty-fifty
  ...
  :list="['Lisez un peu ou beaucoup — c\'est à vous de décider', 'Voyez vos progrès se mettre à jour à chaque entrée de journal', 'Lire ~86 versets par jour signifie que vous terminerez la Bible en un an']"
  button-text="Commencer gratuitement"
...
<content-fifty-fifty
  ...
  :list="['Modifiez ou consultez toute entrée de journal', 'Les étoiles dorées montrent les jours où vous avez atteint votre objectif', 'Exportez ou importez votre journal de lecture à tout moment']"
  button-text="Commencer gratuitement"
  button-destination="/register"
  :reverse="false"></content-fifty-fifty>
